...
# Cloud Run
api_container_image = "europe-west2-docker.pkg.dev/manypets-ml-dev/serving-images/prediction-api:v1.2.3"
authorized_api_invokers = [
  "serviceAccount:frontend-service@manypets-dev.iam.gserviceaccount.com"
]
allowed_ip_ranges = [
  "10.0.0.0/8",
  "203.0.113.0/24"
